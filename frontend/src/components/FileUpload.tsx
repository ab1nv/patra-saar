  ...
  if (!isMounted) {
    return (
      <div className="w-full max-w-2xl mx-auto p-6">
        <div className="relative border-2 border-dashed rounded-lg p-8 text-center transition-colors border-white/20 hover:border-white/40">
          <div className="flex flex-col items-center space-y-4">
            ...
            <Button variant="outline" className="mt-4 border-white/20 text-white hover:bg-white/10" disabled>
